    ...
    return declare(null, {
        ...
        _createWebMap: function (itemInfo) {
            ...
            arcgisUtils.createMap(itemInfo, "noShow", {
                ...
                maptiksMap.on("load", lang.hitch(this, function (args) {
                    // Remove the initial base layer that was generated by maptiks/Map
                    var basemapLayerId = args.map.basemapLayerIds[0];
                    var basemapLayer = args.map.getLayer(basemapLayerId);
                    if (basemapLayer) {
                        args.map.removeLayer(basemapLayer);
                    }
                }));
                this.map = maptiksMap;
